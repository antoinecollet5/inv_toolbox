...
theoretical, and one given from the field to optimize).

Several norms can be used: https://stats.stackexchange.com/questions/82076/similarity-measure-between-multiple-distributions
