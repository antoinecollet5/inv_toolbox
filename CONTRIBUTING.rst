...
Please report defects using the `GitHub Issue Tracker <https://github.com/antoinecollet5/inv_toolbox/issues>`_.
...
- Information about your environment (OS, Python version, inv_toolbox version)
...
`GitHub Issue Tracker <https://github.com/antoinecollet5/inv_toolbox/issues>`_.
...
inv_toolbox documentation, in docstrings, tutorials, or external resources such as blog posts and articles.
...
`labels <https://github.com/antoinecollet5/inv_toolbox/labels>`_ and milestones.
...
2. Clone your fork locally::
    ...
    $ git clone git@github.com:your_username/inv_toolbox.git
    $ cd inv_toolbox
