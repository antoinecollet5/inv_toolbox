import numpy as np
import pytest
from inv_toolbox.regularization import ProbDistFitting
from inv_toolbox.regularization.distribution import (
    cdf_distance,
    cdf_distance_gradient,
    get_cdfs,
)
from inv_toolbox.utils import NDArrayFloat
from inv_toolbox.utils.finite_differences import is_gradient_correct
